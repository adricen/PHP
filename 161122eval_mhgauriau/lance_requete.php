...
<html lang="fr">
  ...
  <body>
    <div class="container">
    <h1 style="text-align: center;">Evaluation du 161123</h1>
    <h3 style="text-align: center;">Marie-Hélène Gauriau</h3>
...
// on teste si une requete existe par le fait qu'il y ait bien des lignes de résultat
      if (!empty($resultat->num_rows)) 
      {
        ...
        echo '<table border="1" style="border-collapse: collapse; width: 100%;">';
          ...
          {
            echo '<th style="background-color: indigo; color: white; padding: 10px; font-size: 18px;">' . $colonne->name . '</th>'; //titres des colonnes
          }
          echo '</tr>';
